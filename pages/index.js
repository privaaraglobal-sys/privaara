...
<a class="wa-float" href="https://wa.me/919051485940?text=Hello%20PRIVAARA%2C%20I%27d%20like%20to%20enquire%20about%20your%20luxury%20surface%20embellishments." target="_blank" rel="noopener noreferrer" aria-label="Chat with PRIVAARA on WhatsApp">
  <svg viewBox="0 0 32 32" width="30" height="30" aria-hidden="true" focusable="false">
    <path fill="currentColor" d="M16.003 3.2c-7.06 0-12.8 5.74-12.8 12.8 0 2.257.593 4.46 1.72 6.4L3.2 28.8l6.57-1.72a12.74 12.74 0 0 0 6.23 1.62h.005c7.06 0 12.8-5.74 12.8-12.8 0-3.42-1.332-6.635-3.75-9.052A12.71 12.71 0 0 0 16.003 3.2zm0 23.36h-.004a10.6 10.6 0 0 1-5.4-1.48l-.387-.23-4.003 1.05 1.07-3.902-.252-.4a10.56 10.56 0 0 1-1.62-5.65c0-5.87 4.777-10.646 10.653-10.646 2.845 0 5.52 1.11 7.53 3.122a10.58 10.58 0 0 1 3.118 7.53c0 5.876-4.777 10.652-10.653 10.652zm5.84-7.976c-.32-.16-1.894-.934-2.188-1.04-.293-.107-.507-.16-.72.16-.213.32-.826 1.04-1.013 1.253-.187.213-.373.24-.693.08-.32-.16-1.352-.498-2.576-1.588-.952-.85-1.594-1.9-1.78-2.22-.187-.32-.02-.493.14-.652.144-.143.32-.373.48-.56.16-.187.213-.32.32-.533.107-.213.053-.4-.027-.56-.08-.16-.72-1.736-.987-2.376-.26-.624-.524-.54-.72-.55l-.613-.01c-.213 0-.56.08-.853.4-.293.32-1.12 1.094-1.12 2.67 0 1.576 1.147 3.098 1.307 3.312.16.213 2.256 3.445 5.466 4.83.764.33 1.36.527 1.824.674.767.244 1.464.21 2.016.127.615-.092 1.894-.774 2.16-1.522.267-.747.267-1.387.187-1.52-.08-.133-.293-.213-.613-.373z"/>
  </svg>
